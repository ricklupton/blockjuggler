...
from blockjuggler import Convertor
...
class Scenario(object):
    ...
    def __init__(self, cfg_file):
        ...
        self.expected_file = cfg_file.new(ext=".expected.tjp")
        """Expected result of conversion to tjp format"""
...
def test_conversion(scenario, tmpdir):
    ...
    expected_file = tmpdir / "expected.tjp"
    ...
    convertor = Convertor(scenario.parameters["resource_id"],
                          scenario.parameters["days"])

    result_file = tmpdir / "output.tjp"
